...
## Steps to run: Install Python, Download the project files into one folder, Open a terminal in that folder, Run: pip install -r requirements.txt in termina, Start the app: python app.py, Click the Gradio link that appears in the terminal, Use the interface to visualize binary search.

## https://huggingface.co/spaces/samsaves/Sams_Binary_App

## Author: Sam Savarie. I used ChatGPT level 4 as authorized by my teacher. I used it only to assist in building the animation logic using Gradio’s generator features, ChatGPT’s role was to support the project with code scaffolding, explanations, and design suggestions.
